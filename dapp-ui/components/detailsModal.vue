  ...
  <div id="killmodal">
    <div class="modal-mask">
      <div  class="modal-wrapper">
        <div class="modal-container animate__bounceIn">
          <div class="modal-header">
            <h3 slot="header" v-on:click="toggle" class="test" >Recycle Bin Details</h3>
          </div>
          <div class="modal-body">
            <slot name="body">
              <h3>Location: {{bookData.name}}</h3>
              <!-- <h3>Price: {{bookData.price}} TRX/Day</h3> -->
              <p>Capacity: {{bookData.description}}</p>
              <div class="row ml-4 p-2">
                <datepicker :value="startDate" v-model="startDate"></datepicker>
                <datepicker v-model="endDate"></datepicker>
              </div>
              <b-button v-on:click="book" class="mr-5 mt-3 recycle">
...
export default {
  ...
  methods: {
    ...
    toggle() {
      ...
      var a = document.getElementById('killmodal');
